				...
				<div class="container">
					<div class="nav-header">
						...
						<img onclick="location.href='index.jsp'"
							src="images/logo_s2s2.png" class="img_sj"
							alt="Free HTML5 Bootstrap Template by FreeHTML5.co" />
						<h1 class="login_btn">
							<a id="login_btn" href="A_LoginForm.jsp">로그인</a>
						</h1>
						<h3 class="login_btn" id="name_h"></h3>
						<nav id="fh5co-menu-wrap" role="navigation">
							<ul class="sf-menu" id="fh5co-primary-menu">
								<li class="active"><a href="admin.jsp">DashBoard</a></li>
								<li><a href="admin_comm.jsp">게시글관리</a></li>
								<li><a href="admin_chat.jsp">채팅관리</a></li>
