...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("#schChatRoom [name=name]").keyup(function(){
			schChatRoom()
		})
	...
	function schChatRoom(){
		$.ajax({
			url:"z/z_chatRoom_search.jsp",
			data:$("#schChatRoom").serialize(),
			dataType:"json",
			success:function(chatRoomList){
				var chatRoomHTML=""
				$(chatRoomList).each(function(idx, chatRooms){
					chatRoomHTML+="<li>"+ chatRooms.name +"</li>"
				})
				$("#chatRoomList").html(chatRoomHTML)
				alert("ㅅㄱ")
			},
			error:function(err){
				console.log(err)
...
<div class="chat-body">
  <div class="container clearfix">
    ...
    <form id="schChatRoom" class="form" method="post">
      <div class="search">
        <input name="name" type="text" placeholder="search" />
        <button type="submit"><i class="fa fa-search"></i></button>
      </div>
      </form>
      <ul class="list" id="chatRoomList">
        <li class="clearfix">
    ...
    <div class="chat">
      ...
      <div class="chat-message clearfix">
      	<form action="" id="chatfrm" class="form" method="post" onsubmit="sendMessage(event)">
      		<input type="hidden" name="sendUserID" value="<%=id%>">
      		<input type="hidden" name="sendUserID" value="">
