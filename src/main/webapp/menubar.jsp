...
%>
		...
		<header id="fh5co-header-section" class="sticky-banner">
			<div class="container">
				<div class="nav-header">
					...
					<div class="propic_div"> <img class="propic" id="profile" src=""> </div>
					...
					<nav id="fh5co-menu-wrap" role="navigation">
						<ul class="sf-menu" id="fh5co-primary-menu">
							...
							<li><a href="Z_MyPage(allMembers,like,block,mywriting).jsp">마이페이지</a></li>
	...
	<script>
		...
		var profileb = document.getElementById("profile")
		if (id == "null"){
			id=""
			...
			nameb.innerText =" "
			heartb.innerText = " "
			profileb.src = "Uploads/orign.png"
		}
		else{
